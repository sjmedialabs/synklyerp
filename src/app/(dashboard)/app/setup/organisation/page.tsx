...
import { GitBranch, FileText, ChevronRight, Shuffle, MessageCircle } from "lucide-react";
...
const SETUP_MODULES = [
  ...
  },
  {
    ...
    description: "Connect Meta WhatsApp credentials for lead chat, number validation, and inbound messages.",
    href: "/app/setup/organisation/whatsapp",
    icon: MessageCircle,
  },
];
