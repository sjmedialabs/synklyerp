...
export const SIDEBAR_MENU_CATALOG: MenuSeedNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { slug: "whatsapp-api", name: "WhatsApp Business API", path: "/app/setup/organisation/whatsapp", icon: "message-circle", status: "built", sortOrder: 4 },
      { slug: "dograh-ai", name: "Dograh AI Voice", path: "/app/setup/organisation/dograh", icon: "bot", status: "built", sortOrder: 5 },
      { slug: "branches", name: "Branch Management", path: "/app/organisation/branches", icon: "git-branch", permissionModule: "organisation", permissionFeature: "branches", status: "built", sortOrder: 6 },
      { slug: "divisions", name: "Divisions", path: "/app/organisation/divisions", icon: "network", permissionModule: "organisation", permissionFeature: "divisions", status: "built", sortOrder: 7 },
      { slug: "designations", name: "Designations", path: "/app/organisation/designations", icon: "badge-check", permissionModule: "organisation", permissionFeature: "designations", status: "built", sortOrder: 8 },
      { slug: "users", name: "Users & Roles", path: "/app/organisation/users", icon: "users", permissionModule: "organisation", permissionFeature: "users", status: "built", sortOrder: 9 },
      { slug: "taxes", name: "Taxes", path: "/app/organisation/taxes", icon: "receipt", permissionModule: "organisation", permissionFeature: "taxes", status: "built", sortOrder: 10 },
      { slug: "approval-workflows", name: "Approval Workflows", path: "/app/setup/approval-workflows", icon: "git-merge", status: "pending", sortOrder: 11 },
      { slug: "business-settings", name: "Business Settings", path: "/app/setup/business-settings", icon: "settings-2", status: "pending", sortOrder: 12 },
    ],
  },
  {
    slug: "hr",
    ...
    children: [
        ...
        children: [
          {
            ...
            name: "Designations",
            path: "/app/hr/master-data/designations",
            icon: "badge-check",
            permissionModule: "hr",
            permissionFeature: "employees",
            status: "built",
      ...
      { slug: "attendance", name: "Attendance & Leave", path: "/app/hr/attendance", icon: "calendar-check", permissionModule: "hr", permissionFeature: "attendance", status: "built", sortOrder: 3 },
      { slug: "payroll", name: "Payroll & Compensation", path: "/app/hr/payroll", icon: "banknote", permissionModule: "hr", permissionFeature: "payroll", status: "built", sortOrder: 4 },
      { slug: "performance", name: "Performance Management", path: "/app/hr/performance", icon: "trending-up", permissionModule: "hr", permissionFeature: "employees", status: "scope", sortOrder: 5 },
      { slug: "recruitment", name: "Recruitment & Hiring", path: "/app/hr/recruitment", icon: "user-plus", status: "pending", sortOrder: 6 },
      { slug: "hr-documents", name: "Employee Documents", path: "/app/hr/documents", icon: "file-text", status: "pending", sortOrder: 7 },
      { slug: "hr-policies", name: "HR Policies", path: "/app/hr/policies", icon: "book-open", status: "pending", sortOrder: 8 },
      { slug: "asset-allocation", name: "Asset Allocation", path: "/app/hr/assets", icon: "package", status: "pending", sortOrder: 9 },
    ],
  },
  {
    slug: "finance",
  ...
  },
  {
    ...
    children: [
      ...
      { slug: "contact-history", name: "Contact History", path: "/app/sales/leads/communication-history", icon: "history", permissionModule: "sales", permissionFeature: "leads", status: "built", sortOrder: 2 },
      { slug: "orders", name: "Orders & Invoices", path: "/app/sales/orders", icon: "shopping-bag", status: "pending", sortOrder: 3 },
      { slug: "customers", name: "Customer Management", path: "/app/sales/customers", icon: "users", status: "pending", sortOrder: 4 },
      { slug: "targets", name: "Targets & Quotas", path: "/app/sales/targets", icon: "target", status: "pending", sortOrder: 5 },
      { slug: "api-forms", name: "API & Forms", path: "/app/sales/api-forms", icon: "code", status: "pending", sortOrder: 6 },
    ],
  },
  {
    slug: "marketing",
...
/** Slugs hidden from sidebar (routes may still exist). */
export const REMOVED_MENU_SLUGS = new Set([
  "organisation-hub",
  "lead-capture-hub",
  "crm-pipelines",
  "crm-automation",
