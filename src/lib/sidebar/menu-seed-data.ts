...
export const SIDEBAR_MENU_CATALOG: MenuSeedNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { slug: "orders", name: "Orders & Invoices", path: "/app/sales/orders", icon: "shopping-bag", status: "pending", sortOrder: 2 },
      { slug: "customers", name: "Customer Management", path: "/app/sales/customers", icon: "users", status: "pending", sortOrder: 3 },
      { slug: "targets", name: "Targets & Quotas", path: "/app/sales/targets", icon: "target", status: "pending", sortOrder: 4 },
      { slug: "api-forms", name: "API & Forms", path: "/app/sales/api-forms", icon: "code", status: "pending", sortOrder: 5 },
    ],
  },
  {
    slug: "marketing",
