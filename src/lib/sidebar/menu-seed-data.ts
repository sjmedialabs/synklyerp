...
export const SIDEBAR_MENU_CATALOG: MenuSeedNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { slug: "lead-capture-hub", name: "Lead Capture Hub", path: "/app/sales/capture", icon: "radio", permissionModule: "sales", permissionFeature: "leads", status: "built", sortOrder: 2 },
      { slug: "crm-pipelines", name: "Sales Pipelines", path: "/app/sales/pipelines", icon: "git-branch", permissionModule: "sales", permissionFeature: "leads", status: "built", sortOrder: 3 },
      { slug: "crm-automation", name: "CRM Automation", path: "/app/sales/automation", icon: "zap", permissionModule: "sales", permissionFeature: "leads", status: "built", sortOrder: 4 },
      { slug: "crm-duplicates", name: "Duplicate Queue", path: "/app/sales/duplicates", icon: "copy", permissionModule: "sales", permissionFeature: "leads", status: "built", sortOrder: 5 },
      { slug: "crm-reports", name: "CRM Reports", path: "/app/sales/reports", icon: "bar-chart-2", permissionModule: "sales", permissionFeature: "leads", status: "built", sortOrder: 6 },
      { slug: "crm-communication", name: "Communication Hub", path: "/app/sales/communication", icon: "mail", permissionModule: "sales", permissionFeature: "leads", status: "built", sortOrder: 7 },
      { slug: "crm-campaigns", name: "Campaigns", path: "/app/sales/campaigns", icon: "megaphone", permissionModule: "sales", permissionFeature: "leads", status: "built", sortOrder: 8 },
      { slug: "opportunities", name: "Opportunity Pipeline", path: "/app/sales/opportunities", icon: "funnel", status: "pending", sortOrder: 9 },
      { slug: "quotations", name: "Quotations", path: "/app/sales/quotations", icon: "file-check", status: "pending", sortOrder: 10 },
      { slug: "orders", name: "Orders & Invoices", path: "/app/sales/orders", icon: "shopping-bag", status: "pending", sortOrder: 11 },
      { slug: "customers", name: "Customer Management", path: "/app/sales/customers", icon: "users", status: "pending", sortOrder: 12 },
      { slug: "targets", name: "Targets & Quotas", path: "/app/sales/targets", icon: "target", status: "pending", sortOrder: 13 },
      { slug: "api-forms", name: "API & Forms", path: "/app/sales/api-forms", icon: "code", status: "pending", sortOrder: 14 },
      { slug: "customer-support", name: "Customer Support", path: "/app/sales/support", icon: "headphones", status: "pending", sortOrder: 15 },
    ],
  },
  {
    slug: "marketing",
